...
import { BarChart3, Shield, ShieldCheck, Globe, Zap, FileCheck, UsbIcon, Filter, Search, Cloud, Bug } from 'lucide-react';
          ...
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  <div className="card__header flex flex-col items-start gap-2 relative text-black mb-2">
                    {card.icon && <card.icon size={20} className="text-gray-600" />}
                    <h3 className="card__title font-normal text-xl m-0">
                      {card.title}
                    </h3>
                  </div>
                  <div className="card__content flex flex-col relative text-black">
                    <span className="card__label text-base text-gray-500 mb-2">{card.label}</span>
                    <p
                      className={`card__description text-base leading-6 opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`}
                    >
                      {card.description}
                    </p>
                  </div>
